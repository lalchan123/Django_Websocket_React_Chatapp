    ...
    useEffect(()=>{
        ...
        const fetchInterest = async () => {
            try {
                ...
                const response = await axios.get('http://127.0.0.1:8080/api/recieved-interest/', {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                    },
                });
    ...
    function sendRequest(userId) {
        const sendReq = async () => {
            ...
            try {
                ...
                const response = axios.post('http://127.0.0.1:8080/api/send-interest/', postData, {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
    ...
    function rejectUser(id){
        const fetchUsers = async () => {
            try {
                ...
                const response = await axios.post('http://127.0.0.1:8080/api/reject-interest/', postData, {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                        'Content-Type': 'application/json' 
                    },
    ...
    function acceptUser(id) {
        const fetchUsers = async () => {
            try {
                ...
                const response = await axios.post('http://127.0.0.1:8080/api/accept-interest/', postData, {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                        'Content-Type': 'application/json'
                    },
